    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "Commissions To Recieve", route: "/commissions-to-receive", role: RolesEnum.Commercial },
          { label: "Commissions", route: "/commissions", role: RolesEnum.Financial },
          { label: "Add New Commissions", route: "/commissions/new", role: RolesEnum.Financial }
        ],
      },
    ],
  },
